...
export const initiateRegistration = async ({ name, lastName, birthDate, email, password, userType }) => {
  try {
    ...
    console.log("Error en initiateRegistration:", error);
    return { ok: false, status: "internal_error", message: "Error interno al iniciar el registro" };
  }
};
...
export const confirmRegistration = async (verificationCodeRequest, registrationToken) => {
  try {
    ...
    console.log("Error en confirmRegistration:", error);
    return { ok: false, status: "internal_error", message: "Error interno al confirmar el registro" };
  }
};
